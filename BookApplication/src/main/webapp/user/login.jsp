...
<link
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
		<link rel="stylesheet"
			...
			<style>
$
form-bg: #13232f ; $white: #ffffff ; $main: #1ab188 ; $main-light: lighten 
	 ($main, 5%); $main-dark: darken ($main, 5%); $gray-light: #a0b3b0 ; $gray: #ddd 
	 ; $thin: 300; $normal: 400; $bold: 600; $br: 4px ; *, *:before, *:after
	{
...
<body background="../../assests/images/Login.jpg">
	...
	<div class="form">
		...
		<ul class="tab-group">
			<b><li class="tab active"><a href="#signup">SIGN IN</a></li></b>
		</ul>
